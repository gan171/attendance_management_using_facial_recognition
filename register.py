...
class register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\91970\Documents\Python_Test_Projects\Images_GUI\bgReg.jpg")
        ...
        # img1=Image.open(r"C:\Users\91970\Documents\Python_Test_Projects\Images_GUI\reg1.png")
        ...
        loginbtn=Button(frame,command=self.loginbtn,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#002B53",activeforeground="white",activebackground="#007ACC")
